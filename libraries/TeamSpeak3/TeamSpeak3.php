 ...
 *
 * $Id: TeamSpeak3.php 7/26/2013 8:28:58 scp@orilla $
 *
 ...
 * @endcode
 *
 * \subsection example3 3. Modify the Settings of each Virtual Server
 * @code
 ...
 * @endcode
 *
 * \subsection example4 4. Create a Privilege Key for a Server Group
 * @code
 *   // connect to local server, authenticate and spawn an object for the virtual server on port 9987
 *   $ts3_VirtualServer = TeamSpeak3::factory("serverquery://username:password@127.0.0.1:10011/?server_port=9987");
 *
 *   // spawn an object for the group using a specified nickname
 ...
 * @endcode
 *
 * \subsection example5 5. Modify the Permissions of Admins on each Virtual Server
 * @code
 *   // connect to local server, authenticate and spawn an object for the server instance
 *   $ts3_ServerInstance = TeamSpeak3::factory("serverquery://username:password@127.0.0.1:10011/");
 *
 ...
 * @endcode
 *
 * \subsection example6 6. Create a new Virtual Server
 * @code
 *   // connect to local server, authenticate and spawn an object for the server instance
 *   $ts3_ServerInstance = TeamSpeak3::factory("serverquery://username:password@127.0.0.1:10011/");
 *
 ...
 * @endcode
 *
 * \subsection example7 7. Create a hierarchical Channel Stucture
 * @code
 *   // connect to local server, authenticate and spawn an object for the virtual server on port 9987
 *   $ts3_VirtualServer = TeamSpeak3::factory("serverquery://username:password@127.0.0.1:10011/?server_port=9987");
 *
 ...
 * @endcode
 *
 * \subsection example8 8. Send a Text Message to outdated Clients
 * @code
 *   // connect to local server, authenticate and spawn an object for the virtual server on port 9987
 *   $ts3_VirtualServer = TeamSpeak3::factory("serverquery://username:password@127.0.0.1:10011/?server_port=9987");
 *
 ...
 * @endcode
 *
 * \subsection example9 9. Check if the Server Instance is Outdated or Blacklisted
 * @code
 *   // connect to local server, authenticate and spawn an object for the server instance
 *   $ts3_ServerInstance = TeamSpeak3::factory("serverquery://username:password@127.0.0.1:10011/");
 *
 ...
 * @endcode
 *
 * \subsection example10 10. Create a simple TSViewer for your Website
 * @code
 *   // connect to local server, authenticate and spawn an object for the virtual server on port 9987
 *   $ts3_VirtualServer = TeamSpeak3::factory("serverquery://username:password@127.0.0.1:10011/?server_port=9987");
 *
 ...
 * @endcode
 *
 * \subsection example11 11. Update all outdated Audio Codecs to their Opus equivalent
 * @code
 *   // connect to local server, authenticate and spawn an object for the virtual server on port 9987
 *   $ts3_VirtualServer = TeamSpeak3::factory("serverquery://username:password@127.0.0.1:10011/?server_port=9987");
 *
 ...
 * @endcode
 *
 * \subsection example12 12. Display the Avatar of a connected User
 * @code
 *   // connect to local server, authenticate and spawn an object for the virtual server on port 9987
 *   $ts3_VirtualServer = TeamSpeak3::factory("serverquery://username:password@127.0.0.1:10011/?server_port=9987");
 *
 ...
 * @endcode
 *
 * \subsection example13 13. Create a Simple Bot waiting for Events
 * @code
 ...
 * @endcode
 *
 * \subsection example14 14. Handle Errors using Exceptions
 * @code
 *   try
 *   {
 *     // connect to local server, authenticate and spawn an object for the virtual server on port 9987
